...
export function MixerPanel() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-20 bg-[#0a0a0a] border-t border-[#222] z-50 flex justify-center shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
      <div className="max-w-7xl w-full mx-auto px-6 flex items-center justify-between h-full">
