...
export function MixerPanel() {
    ...
    return (
        <>
            <div className="fixed bottom-0 left-0 right-0 h-16 sm:h-20 bg-grid-bg border-t border-[#222] z-50 flex justify-center shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
                <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 flex items-center justify-between h-full">
                    <div className="flex items-center gap-4 sm:gap-6 overflow-x-auto no-scrollbar mask-edges">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3">
                            {displayIds.map((id) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <span className="text-[#888] font-mono shrink-0">
                            ...
                            {remainingCount > 0 && (
                                <div className="flex items-center gap-2 px-3 py-1.5 bg-[#111] border border-[#333] text-xs font-medium text-[#888] shrink-0">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4 ml-4 sm:ml-6 shrink-0">
                        <button
                            type="button"
                        ...
                        <button
                            ...
                            className="flex items-center justify-center sm:justify-start gap-2 w-10 sm:w-auto sm:px-4 h-9 border border-[#444] bg-[#111] hover:bg-[#222] transition-colors text-sm font-medium text-grid-text-secondary hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
                        >
                            {isSaved ? (
                                <HugeiconsIcon
                                    icon={TickIcon}
                        ...
                        <button
                            ...
                            className="flex items-center justify-center sm:justify-start gap-2 w-10 sm:w-auto sm:px-4 h-9 border border-[#444] bg-black hover:bg-[#111] transition-colors text-sm font-medium text-grid-text-secondary hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
                        >
                            <HugeiconsIcon
                                icon={Cancel01Icon}
                                className="w-3.5 h-3.5"
